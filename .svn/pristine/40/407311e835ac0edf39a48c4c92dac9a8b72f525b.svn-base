...
public class SeekBarPreference extends Preference implements
	...
	protected View onCreateView(ViewGroup parent) {
		...
		view.setTextColor(android.R.color.primary_text_dark);
		view.setTextAppearance(this.getContext(), android.R.style.TextAppearance_Large);
		...
		this.monitorBox.setText(bar.getProgress() + " km");
	...
	public void onProgressChanged(SeekBar seekBar, int progress,
		...
		this.monitorBox.setText(progress + " km");
